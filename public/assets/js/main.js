...
function toggleLanguage() {
  ...
  // Set the HTML lang attribute to change the language
  document.documentElement.lang = newLanguage;

  // You may want to update other elements on your page based on the language
  updateContentBasedOnLanguage(newLanguage);
}
...
function updateContentBasedOnLanguage(language) {
  ...
  if (language === 'ar') {
      document.getElementById('header').innerText = 'مرحبًا بك في موقعنا';
      // Add similar updates for other elements
  } else {
      document.getElementById('header').innerText = 'Welcome to Our Website';
      // Add similar updates for other elements
  }
}
